...
impl ZipArchive {
  ...
  fn entry_ref(&self, entry_id: &NamespaceNodeId) -> Result<&ZipEntry> {
...
) -> Result<(Vec<ZipEntry>, HashMap<String, NamespaceNodeId>)> {
...
crate::archives::driver::impl_archive_data_source!(ZipArchive);
